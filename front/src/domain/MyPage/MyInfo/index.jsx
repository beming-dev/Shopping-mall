...
export default function MyInfo() {
  ...
  return (
    <div className="myInfo">
      <form
        action="http://localhost:3001/process_update_info"
        className="field"
        method="post"
      >
        ...
        <label htmlFor="pw" className="label_pw">
          password
        </label>
        <input type="password" id="pw" name="pw" onBlur={onBlur}></input>
        <label htmlFor="pwc" className="label_pwc">
          password check
        </label>
      ...
      <Link to="/seller-registration" className="seller-registration">
        seller registration
      </Link>
    </div>
  );
